...
const stdout = execSync('quicktype ./data/data.json -o ./languages/csharp/CevioCasts/Definitions.cs -l cs --namespace CevioCasts --features complete -S ./model/schema.json')
